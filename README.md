...
1. Choosing an LLM provider (Anthropic, OpenAI, Ollama, OpenRouter, or OpenAI-compatible)
...
| State | Zustand |
| LLM | Vercel AI SDK (Anthropic, OpenAI, Ollama, OpenRouter, OpenAI-compatible) |
