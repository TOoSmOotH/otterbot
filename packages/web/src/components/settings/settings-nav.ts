...
const ICONS = {
  ...
  bluesky: ["M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266.902 1.565.139 1.908 0 3.08 0 3.768c0 .69.378 5.65.574 6.456.681 2.802 3.16 3.522 5.408 3.107-3.948.678-8.317 2.03-3.053 7.098C7.862 25.242 10.349 20.4 12 17.174c1.651 3.226 4.138 8.068 9.071 3.255 5.264-5.068.895-6.42-3.053-7.098 2.248.415 4.727-.305 5.408-3.107C23.622 9.418 24 4.458 24 3.768c0-.688-.139-1.86-.902-2.203-.659-.299-1.664-.621-4.3 1.24C16.046 4.747 13.087 8.686 12 10.8z"],
  mastodon: ["M21.327 8.566c0-4.339-2.843-5.61-2.843-5.61-1.433-.658-3.894-.933-6.451-.953h-.063c-2.557.02-5.016.295-6.45.953 0 0-2.843 1.271-2.843 5.61 0 .993-.019 2.181.012 3.441.103 4.243.778 8.425 4.701 9.463 1.809.479 3.362.579 4.612.51 2.268-.126 3.541-.814 3.541-.814l-.075-1.646s-1.621.511-3.441.449c-1.804-.062-3.707-.194-3.999-2.409a4.523 4.523 0 0 1-.04-.621s1.77.432 4.014.535c1.372.063 2.658-.08 3.965-.236 2.506-.299 4.688-1.843 4.962-3.254.431-2.223.396-5.424.396-5.424z", "M17.7 13.559V8.862c0-.96-.24-1.72-.721-2.28-.497-.56-1.146-.847-1.952-.847-.933 0-1.639.358-2.105 1.075l-.454.761-.454-.761c-.466-.717-1.172-1.075-2.105-1.075-.806 0-1.455.287-1.952.847-.48.56-.721 1.32-.721 2.28v4.697h1.862V9.009c0-.96.404-1.448 1.211-1.448.893 0 1.34.578 1.34 1.72v2.496h1.848V9.281c0-1.142.447-1.72 1.34-1.72.807 0 1.211.488 1.211 1.448v4.55h1.652z"],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "bluesky",
        label: "Bluesky",
        description: "Bluesky social connection",
        icon: "bluesky",
        keywords: ["bsky", "atproto", "social", "decentralized"],
      },
      {
        id: "mastodon",
        label: "Mastodon",
        description: "Mastodon/Fediverse integration",
        icon: "mastodon",
        keywords: ["fediverse", "activitypub", "toot", "social"],
      },
      {
        id: "x",
        label: "X (Twitter)",
