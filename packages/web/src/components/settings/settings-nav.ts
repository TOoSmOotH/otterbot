...
const ICONS = {
  ...
  mastodon: ["M21 7.337h-3.93l.372 4.272c.084.955.32 1.702.6 2.199.39.666.91.89 1.39.89.495 0 1.108-.298 1.568-.66V7.337z", "M3 7.337h3.93l-.372 4.272c-.084.955-.32 1.702-.6 2.199-.39.666-.91.89-1.39.89-.495 0-1.108-.298-1.568-.66V7.337z", "M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2z", "M8 11v5", "M16 11v5", "M9.5 16.5h5"],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "mastodon",
        keywords: ["fediverse", "toot", "social", "activitypub"],
      },
      {
        id: "nextcloud-talk",
